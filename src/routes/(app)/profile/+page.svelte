...
<div class="bg-gray-50">
  ...
  <div class="flex flex-col items-center mb-8">
    <div class="relative mb-4">
      ...
      >
        <div
          class="h-full w-full rounded-full bg-white flex items-center justify-center overflow-hidden border-4 border-white"
        >
      ...
      <!-- Google Badge Icon -->
      <div
        class="absolute bottom-0 right-0 bg-white p-1.5 rounded-full shadow-md border border-gray-100"
      >
        <img
    ...
    <div
      class="px-3 py-1 bg-blue-50 text-[#597dff] rounded-full text-xs font-semibold border border-blue-100"
    >
      Linked with Google
    </div>
  </div>
  ...
  <div class="px-6 space-y-6">
    {#each menuItems as group}
      <div class="space-y-3">
        ...
        <div
          class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden text-left"
        >
              ...
              <div class="flex items-center gap-4">
                <div
                  class="h-10 w-10 rounded-full {item.variant === 'danger'
                    ...
                    : 'bg-blue-50 text-blue-500'} flex items-center justify-center shrink-0"
                >
                  <item.icon size={20} />
                </div>
                <span
